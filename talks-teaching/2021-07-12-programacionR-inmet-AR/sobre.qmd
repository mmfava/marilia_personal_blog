...
subtitle: "Instituto Nacional de Medicina Tropical (INMeT) de Argentina"
image: image.png
execute:
  echo: true
  output: false
...
<button class="custom-button" onclick="window.location.href='https://introduccionalr.netlify.app/'">Site del curso</button>
